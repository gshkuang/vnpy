...
def test_rolling_with_2i_period():
    ...
    assert actual_means == expected_means, f"期望平均值: {expected_means}, 实际平均值: {actual_means}"
    assert actual_counts == expected_counts, f"期望计数: {expected_counts}, 实际计数: {actual_counts}"
